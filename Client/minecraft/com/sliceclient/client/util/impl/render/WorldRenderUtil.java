package com.sliceclient.client.util.impl.render;
...
import com.sliceclient.client.util.impl.render.helper.BlockToColor;

public class WorldRenderUtil implements Util {

    public static void drawBlockESPBlockID(final double x, final double y, final double z, int blockID, final float lineAlpha, final float lineWidth) {
        GL11.glPushMatrix();
        GL11.glEnable(3042);
        ...
        final float[] colors = BlockToColor.getBlockColor(blockID);

        GL11.glColor4f(colors[0], colors[1], colors[2], lineAlpha);
    ...
    public static void drawTracerLineBlock(final double x, final double y, final double z, int blockID, final float alpha, final float lineWdith) {
        GL11.glPushMatrix();
        GL11.glEnable(3042);
        GL11.glEnable(2848);
        GL11.glDisable(2929);
        ...
        GL11.glColor4f(colors[0], colors[1], colors[2], alpha);
        GL11.glBegin(2);
