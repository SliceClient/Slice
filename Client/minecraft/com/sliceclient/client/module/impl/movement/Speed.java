...
public class Speed extends Module {
    ...
    public void setup() {
        ...
        propertyManager.add(new DoubleProperty<>("Speed", this, 1.2F, 0.125F, 10.1F));
        propertyManager.add(new BooleanProperty<>("Flag Check", this, true));
    }
        ...
        switch (event.getPacketDirection()) {
            case INBOUND:
                ...
                if (event.getPacket() instanceof S08PacketPlayerPosLook) {
                	boolean fc = (Boolean) propertyManager.getProperty(this, "Flag Check").getValue();
                	if(fc = true)
                    toggle();
                }
                break;
